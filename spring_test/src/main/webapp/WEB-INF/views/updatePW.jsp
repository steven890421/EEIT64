...
<head>
  ...
  <link rel="stylesheet" href="<c:url value='/css/updatePW.css' />" />
...
<body>
  ...
  <div class="bar">
    <span class="bar-text">設定新密碼</span>
  </div>
	...
	<div class="container " style="height: 70vh;">
		<div style="height: 100%;"
			...
			<div id="formbk" style="height: 400px; width: 400px; padding: 10px;"
				...
				<form class="flex-column d-flex " method="post">
					<h4 class="">設定新密碼</h4>
					<input type="password" class="form-control " id="password"
						placeholder="請輸入新密碼" name="password"> 
					<button type="submit" class="btn " id="mail">送出</button>
...
<script>
 ...
 // 監聽表單提交事件
    $('form').submit(function(event) {
      ...
      // 使用 AJAX 提交表單數據
      $.ajax({
        url: 'http://localhost:8080/updatePW',
        type: 'POST',
        data: {
          email: email,
          password: password
